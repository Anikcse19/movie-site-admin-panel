    ...
    <Layout>
      ...
      <div className="bg-white border-t-4 border-green-600 rounded-tl-lg rounded-tr-lg my-10  py-5">
        ...
        <div className="flex justify-between items-center shadow-lg px-5 py-5">
          <span className="text-xl font-bold ">Imported Trash list</span>
        ...
        <div className="px-3 w-[80%] flex items-center justify-between gap-3 mt-5">
            <div className="bg-red-600 text-white px-3 py-2 rounded-lg  shadow-lg cursor-pointer ">Clear All Trash</div>
