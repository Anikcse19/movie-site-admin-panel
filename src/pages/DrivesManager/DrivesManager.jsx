  ...
  return (
    <Layout>
      ...
      <div className="bg-white border-t-4 border-green-600 rounded-tl-lg rounded-tr-lg my-10  py-5">
        {/* heading start */}
        <div className="flex flex-col md:flex-row justify-between md:items-center shadow-lg px-5 py-5">
          <span className="text-xl font-bold ">Drive List</span>
          <div className="my-5">
        ...
        <div className="px-5 mt-10">
          ...
          <div className="flex flex-col md:flex-row justify-between md:items-center">
            ...
            <div className="flex gap-2 my-3 md:my-0 items-center">
              <span>Serach</span>
              <input
          ...
          {/* table start */}
          <div className=" relative overflow-x-auto max-h-screen max-w-screen overflow-hidden overflow-y-auto my-10 border border-gray-500">
            <table className="ease-in-out w-full text-sm text-left  text-white dark:text-gray-400 ">
              ...
              <tbody className="w-full">
                <tr className="border-b text-gray-700 text-sm">
                  ...
                  <td className="text-center px-3 py-4 border-r border-gray-500">
                    true
                  </td>
                  <td className="text-center px-3 py-4 border-r border-gray-500">anikdebcse@gmail.com</td>
                  <td className="text-center px-3 py-4 border-r border-gray-500">asdasdsgfgh423423</td>
                  ...
                  <td className="text-center px-3 py-4 border-r border-gray-500">Go Base Url</td>
                </tr>
              </tbody>
            </table>
          </div>
